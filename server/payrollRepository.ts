...
import {
  ...
  type InsertPayrollAuditEvent,
  type InsertPayrollPayment,
  type InsertPayrollResultLine,
  type InsertPayrollRun,
  type InsertPayrollRunWorker,
} from "@shared/schema";
import { db } from "./db";
...
function createRepository(database: DrizzleDb): PayrollRepository {
...
export const payrollRepository = createRepository(db);
