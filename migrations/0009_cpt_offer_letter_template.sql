...
SELECT
  ...
  'Formal CPT-focused internship offer letter with dates, hours, work location, supervisor, responsibilities, CPT authorization contingency, and Trainee Workspace acceptance.',
  'active',
  1,
